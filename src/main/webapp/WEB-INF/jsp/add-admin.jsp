...
<!-- Modal Logout -->
<%@include file="includes/logout-modal.jsp" %> <!-- Modal End -->
<!-- Begin page -->
<div id="wrapper">
            ...
            <div class="col-md-12">
                ...
                <div class="widget">
                    <div class="widget-header transparent">
                        <h2><strong>Admin</strong> Registeration Form</h2>
                    ...
                    <div class="widget-content padding">
                        <form class="form-horizontal" role="form" action="admin-listing.html" id="form">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="input-text" placeholder="Name"
                                           value="<%= (data != null ?data.getAdminName():"") %>" required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="input-email" placeholder="Email"
                                           value="<%= (data != null ?data.getAdminEmail():"") %>" required>
                            ...
                            <div class="form-group" <%= (data != null ? "style='display:none'" : "") %> >
                                ...
                                <div class="col-sm-6">
                                    <input type="password" class="form-control" id="inputPassword"
                                           ...
                                           value="<%= (data != null ?data.getAdminPassword():"") %>" required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="inp-cnic" placeholder="cnic"
                                           value="<%= (data != null ?data.getAdminNic():"") %>" required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="inp-phoneNum" placeholder="phone number"
                                           value="<%= (data != null ?data.getAdminPhoneNumber():"") %>" required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <textarea col="12" row="5" class="form-control" id="txt-address"
                                              placeholder="Enter Address"
                                              required><%= (data != null ? data.getAdminAddressId().getAddress() : "") %></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <select class="form-control" id="sel-role" required>
                                        <option value="1" <%= (data != null && data.getAdminAccessType() == 1 ? "selected" : "") %> >
                                            Super Admin
                                        </option>
                                        <option value="2" <%= (data != null && data.getAdminAccessType() == 2 ? "selected" : "") %>>
                                            admin
                                        </option>
                                        <option value="3" <%= (data != null && data.getAdminAccessType() == 3 ? "selected" : "") %>>
                                            Operation
                                        </option>
                                    </select>
