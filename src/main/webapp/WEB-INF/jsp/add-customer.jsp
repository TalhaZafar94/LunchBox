                    ...
                    <div class="widget-content padding">
                        <form class="form-horizontal" role="form" action="customer-listing.html" id="form">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="inp-customer-name" placeholder="Name"
                                           value="<%= (data != null ?data.getCustomerName():"") %>" required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="inp-customer-email"
                                           placeholder="Email Address"
                                           value="<%= (data != null ?data.getCustomerEmail():"") %>" required>
                            ...
                            <div class="form-group" <%= (data != null ? "style='display:none'" : "") %>>
                                ...
                                <div class="col-sm-6">
                                    <input type="password" class="form-control" id="inp-customer-pass"
                                           placeholder="Password"
                                           value="<%= (data != null ?data.getCustomerPassword():"") %>" required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="inp-customer-cnic" placeholder="cnic"
                                           value="<%= (data != null ?data.getCustomerNic():"") %>" required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="inp-customer-phoneNum"
                                           placeholder="phone number"
                                           value="<%= (data != null ?data.getCustomerPhoneNumber():"") %>" required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <textarea id="inp-customer-address" col="12" row="5" class="form-control"
                                              placeholder="Enter Address"
                                              required><%= (data != null ? data.getCustomerAddressId().getAddress() : "") %></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <select id="inp-customer-status" class="form-control" required>
                                        <option value="1" <%= (data != null && data.getCustomerAccessType() == 1 ? "selected" : "") %> >
                                            Active
                                        </option>
                                        <option value="2" <%= (data != null && data.getCustomerAccessType() == 2 ? "selected" : "") %>>
                                            DeActive
                                        </option>
                                        <option value="3" <%= (data != null && data.getCustomerAccessType() == 3 ? "selected" : "") %>>
                                            Suspended
                                        </option>
                                    </select>
