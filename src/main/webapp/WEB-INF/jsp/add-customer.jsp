                    ...
                    <div class="widget-content padding">
                        <form class="form-horizontal" role="form" action="customer-listing.html" id="form">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="inp-customer-name" placeholder="Name" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inp-customer-email" class="col-sm-2 control-label">Email Address</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="inp-customer-email" placeholder="Email Address" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inp-customer-pass" class="col-sm-2 control-label">Password</label>
                                <div class="col-sm-6">
                                    <input type="password" class="form-control" id="inp-customer-pass" placeholder="Password" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="inp-customer-cnic" placeholder="cnic" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inp-customer-phoneNum" class="col-sm-2 control-label">Phone Number</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="inp-customer-phoneNum" placeholder="phone number" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <textarea id="inp-customer-address" col="12" row="5" class="form-control" placeholder="Enter Address" required></textarea>
                                </div>
                            </div>
