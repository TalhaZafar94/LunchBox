            ...
            <div class="col-md-12">
                <div class="widget">
                    <div class="widget-header transparent">
                        <h2><strong>Rider</strong> listing</h2>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="toolbar-btn-action">
                                        <a href="/add-customer?add=new" class="btn btn-success"><i
