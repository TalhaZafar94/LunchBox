<%@ page import="com.example.lunchbox.service.CustomerService" %>
<%@ page import="com.example.lunchbox.service.Impl.CustomerServiceImpl" %><%--
    ...
    <div class="md-content">
        ...
        <div>
            ...
            <p class="text-center">
                ...
                <a href="localhost:8080/login" class="btn btn-success md-close">Yeah, I'm sure</a>
            </p>
        </div>
    </div>
</div>        <!-- Modal End -->
