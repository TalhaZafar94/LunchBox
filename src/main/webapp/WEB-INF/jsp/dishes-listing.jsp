            ...
            <div class="col-md-12">
                <div class="widget">
                    <div class="widget-header transparent">
                        <h2><strong>Dishes</strong> listing</h2>
        ...
        success:function(response){
            ...
            response.forEach(function(dish) {
                ...
                html = '<tr>'+'<td> <input type="checkbox" name="record"> </td>'+
                    ...
                    '<td>'+
                    '<div class="btn-group btn-group-xs">'+
                    '<a data-toggle="tooltip" title="Delete" class="btn btn-default"><i class="fa fa-power-off" value="'+dish.dishId+'" ></i></a>'+
                    '<a data-toggle="tooltip" title="Edit" class="btn btn-default" value="'+dish.dishId+'" ><i class="fa fa-edit"></i></a>'+
                    '</div>'+
                    '</td>'+
                    '</tr>';
