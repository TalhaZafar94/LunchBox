                    ...
                    <div class="widget-content padding">
                        <form class="form-horizontal" role="form" action="dishes-listing.html" id="form">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="inp-dish-name" placeholder="Name" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inp-selling-price" class="col-sm-2 control-label">Initial Selling Price</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="inp-selling-price" placeholder="Name" required>
                                </div>
                            </div>
