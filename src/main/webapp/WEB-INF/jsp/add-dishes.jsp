<%@ page import="com.example.lunchbox.model.entity.Dishes" %><%--
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="widget">
                    ...
                    <% Dishes data = (Dishes) request.getAttribute("dishDetail"); %>

                    <input type="hidden" id="rowId" name="rowId" value="<%= (data != null ?data.getDishId():"") %>">
                    <div class="widget-content padding">
                        <form class="form-horizontal" role="form" action="dishes-listing.html" id="form">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="inp-dish-name" placeholder="Name"
                                           value="<%= (data != null ?data.getDishName():"") %>" required>
                                    <div id="errorName" style="color:#ff3351;display:none">*Please enter name</div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inp-selling-price" class="col-sm-2 control-label">Initial Selling
                                    Price</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="inp-selling-price" placeholder="Name"
                                           value="<%= (data != null ?data.getDishSellingPrice():"") %>" required>
...
<script>
    ...
    function generateDataString(action) {
        if (action == "update") {
            ...
            var dataString = '{ "dishId" :"' + $('#rowId').val() + '","dishName" :"' + $('#inp-dish-name').val() + '",' +
