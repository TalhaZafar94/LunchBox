        ...
        success:function(response){
            ...
            response.forEach(function(customer) {
                ...
                html = '<tr>'+'<td> <input type="checkbox" name="record"> </td>'+
                    ...
                    '<td>'+
                    '<div class="btn-group btn-group-xs">'+
                    '<a data-toggle="tooltip" title="Delete" class="btn btn-default"><i class="fa fa-power-off" value="'+customer.customerId+'" ></i></a>'+
                    '<a data-toggle="tooltip" title="Edit" class="btn btn-default" value="'+customer.customerId+'" ><i class="fa fa-edit"></i></a>'+
                    '</div>'+
                    '</td>'+
                    '</tr>';
