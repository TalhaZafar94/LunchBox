        ...
        <div class="login-wrap">
            <div class="login-block">
                <form role="form" action="http://localhost:8080">
                    <input type="hidden" id="session-email" name="session-email"
                           value="<%= pageContext.getSession().getAttribute("adminEmail")%>">
                    <div class="form-group login-input">
                        <i class="fa fa-key overlay"></i>
                        <input type="password" class="form-control text-input" placeholder="old password" id="old"
                               required>
                    </div>
                    <div class="form-group login-input">
                        <i class="fa fa-key overlay"></i>
                        <input type="password" class="form-control text-input" placeholder="new password" id="new"
                               required>
                    </div>
                    <div class="form-group login-input">
                        <i class="fa fa-key overlay"></i>
