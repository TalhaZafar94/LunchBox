            ...
            <div class="col-md-12">
                <div class="widget">
                    <div class="widget-header transparent">
                        <h2><strong>Admin</strong> listing</h2>
                        ...
                        <div class="table-responsive">
                            <table data-sortable class="table table-hover table-striped">
                                ...
                                <tr>
                                    ...
                                    <th>Address</th>
                                    <th>Email Address</th>
                                    <th data-sortable="false">Phone number</th>
                                    <th>Status</th>
        ...
        success:function(response){
            ...
            response.forEach(function(admin) {
                ...
                html = '<tr>'+'<td> <input type="checkbox" name="record" id="record"> </td>'+
                    ...
                    '<a data-toggle="tooltip" title="Delete" class="btn btn-default"><i class="fa fa-power-off" value="'+admin.adminId+'" ></i></a>'+
                    '<a data-toggle="tooltip" title="Edit" class="btn btn-default" value="'+admin.adminId+'" ><i class="fa fa-edit"></i></a>'+
                    '</div>'+
                    '</td>'+
                    '</tr>';
